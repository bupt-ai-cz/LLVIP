...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/LLVIP_infrared_train.txt"
...
__C.TEST.ANNOT_PATH             = "./data/dataset/LLVIP_infrared_test.txt"
__C.TEST.BATCH_SIZE             = 16
__C.TEST.INPUT_SIZE             = 1280
__C.TEST.DATA_AUG               = False
__C.TEST.WRITE_IMAGE            = True
__C.TEST.WRITE_IMAGE_PATH       = "./data/detection/infrared/"
